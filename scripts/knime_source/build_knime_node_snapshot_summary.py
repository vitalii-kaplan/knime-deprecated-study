...
def main() -> int:
    ...
    if args.snapshots_root.is_absolute():
        parser.error("snapshots_root must be relative to the repository root")
    if args.out.is_absolute():
        parser.error("--out must be relative to the repository root")
