...
support. An exact factory-class join to 62 deduplicated k2pweb workflows finds
deprecated nodes in 21 workflows (33.87\%) and 294 of 2745 node occurrences
(10.71\%).
...
\item Which nodes classified as deprecated in the latest retained source
snapshot occur in the observed k2pweb workflows, and at what prevalence?
\end{enumerate}

The contribution is a reproducible structured-XML mining method, retained
per-snapshot evidence, a longitudinal description of KNIME node metadata from
2018 to 2026, and an exact-identifier join to privacy-limited k2pweb usage data.
The demand-side analysis measures practical exposure without treating
