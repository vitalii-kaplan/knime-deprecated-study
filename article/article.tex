...
\begin{abstract}
Visual workflows support scientific data analysis, but persisted workflows
depend on platform components whose lifecycle changes over time. When studies
do not preserve executable workflows or report platform versions, deprecated
components can complicate later reuse and reproduction. This paper quantifies
how common deprecated nodes are in public KNIME source repositories and in
workflows uploaded by users for KNIME-to-Python conversion. We reconstruct 13
source-date snapshots of the public \texttt{knime-oss} repositories between
April 2018 and June 2026, parse structured extension and compatibility metadata,
build a registry of deprecated factory classes, and join exact factory
identifiers to 2745 node occurrences in 62 k2pweb workflows uploaded between
2026-03-25 and 2026-07-15. Deprecated ordinary-node registrations increase from
193 of 1301 (14.83\%) in the 2018 baseline to 502 of 1506 (33.33\%) in the
latest snapshot, where they represent 487 distinct factory classes. The join
matches 146 of 160 observed factory classes and 2549 of 2745 occurrences.
Twenty-one distinct deprecated factory classes account for 294 occurrences
(10.71\%) and appear in 21 workflows (33.87\%). These results show that
deprecated nodes are not a marginal phenomenon on either the platform or usage
side. 
...
\cite{Fu2025GIScienceKNIME,KaplanKNIMEWorkflowAudit2026}.
...
lifecycle of those nodes and their extensions. A node may remain loadable after
it disappears from the ordinary authoring interface, be mapped to a newer
...
\cite{KaplanKNIMEWorkflowAudit2026}. Missing workflow artifacts and version
information make it harder to determine which node implementations a study
used and whether those components remain available.
